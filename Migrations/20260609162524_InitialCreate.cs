    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@pollingapp.com", true, "$2a$12$Z0H9kU.iJg1tEebmPZ/jQO4q0kS/qI4K1b3qDq5.O3G2Z3P6lO7yG", "Admin", "admin" },
                    { 2L, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "user@pollingapp.com", true, "$2a$12$hCenLp787qOswX3T.j03WODNq3b4V16W0y9lM.U.Z4aC8a6v6rPte", "User", "user" }
                });
