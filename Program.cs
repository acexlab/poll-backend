...
using pollbackend.Middleware;
using pollbackend.Services;
using pollbackend.Mappings;
using pollbackend.Validators;
...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.SetIsOriginAllowed(origin => true) // Allow any origin dynamically (handles localhost, 127.0.0.1, server IPs, etc.)
              .AllowAnyHeader()
              .AllowAnyMethod()
              .AllowCredentials();
    });
