...
namespace pollbackend.Infrastructure.Persistence
{
    public class PollDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Seed initial data
            // Default Admin Username: admin, Password: adminpassword (hashed)
            // Default User Username: user, Password: userpassword (hashed)
            // St statically pre-hashed BCrypt strings:
            // "adminpassword" -> $2a$12$Z0H9kU.iJg1tEebmPZ/jQO4q0kS/qI4K1b3qDq5.O3G2Z3P6lO7yG
            // "userpassword" -> $2a$12$hCenLp787qOswX3T.j03WODNq3b4V16W0y9lM.U.Z4aC8a6v6rPte
